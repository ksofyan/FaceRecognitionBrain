...
class Signin extends React.Component {
	constructor(props){
		...
		onSubmitSignIn = () => {
			fetch('https://kssmartbrain.herokuapp.com/signin', {
				method: 'post',
...
// instead of this.props.onRouteChange we can deconstruct the code by const {onRouteChange} = this.props; at the top of the page